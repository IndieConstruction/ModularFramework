...
namespace ModularFramework.Modules {
    ...
    public class PlayerProfileModuleDefault : IPlayerProfileModule {
...
#if Newtonsoft
            serializedObjs = JsonConvert.SerializeObject(_newPlayer);
#endif
            if (!string.IsNullOrEmpty(serializedObjs))
        ...
        public void SaveAllPlayerProfiles() {
            string serializedObjs = string.Empty;
#if Newtonsoft
            serializedObjs = JsonConvert.SerializeObject(AvailablePlayers);
#endif
